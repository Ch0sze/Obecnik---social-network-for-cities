...
{
    /// <inheritdoc />
    public partial class AddPetitionSignatureTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetitionSignatures", x => new { x.UserId, x.PostId });
                    table.ForeignKey(
                        name: "FK_PetitionSignatures_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetitionSignatures_PostId",
